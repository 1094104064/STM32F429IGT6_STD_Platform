...
#define MY_DISP_BASE_ADDR 0xD0000000
...
void lv_port_disp_init(void)
{
    ...
    static lv_color_t * buf_2_1 = (lv_color_t *)(MY_DISP_BASE_ADDR + MY_DISP_HOR_RES * MY_DISP_VER_RES * 2);
    static lv_color_t * buf_2_2 = (lv_color_t *)(MY_DISP_BASE_ADDR + MY_DISP_HOR_RES * MY_DISP_VER_RES * 3);
    ...
    if(disp_flush_enabled) {
        ...
        for(y = area->y1; y <= area->y2; y++) {
            for(x = area->x1; x <= area->x2; x++) {
                ...
                bsp_wrapper_display_draw_pixel(x, y, *(uint32_t *)color_p);
                color_p++;
            }
        }
